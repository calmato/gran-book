    ...
    <View>
      ...
      <ScrollView contentContainerStyle={styles.container} style={{marginBottom: 'auto'}}>
        ...
        <Text style={styles.titleContainer}>
          題名: {book.volumeInfo.title}
        </Text>
        <Text style={styles.authorContainer}>
          著者: { book.volumeInfo?.authors? book.volumeInfo?.authors.join(' ') : '著者情報がありません' }
        </Text>
        ...
        <FlexBoxBookCategory
          category={ book.volumeInfo.categories? book.volumeInfo.categories.join(' ') : 'カテゴリ情報がありません' }
        />
