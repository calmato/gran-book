...
export const ERROR_MESSAGE = {
  ...
  UNAUTHORIZED: '権限がありません。アプリを再起動してください。',
  PROCESS_FAILED: '正常に処理できませんでした。しばらく経ってからもう一度お試しください。',
  SERVER_ERROR: 'サーバーエラーが発生しました。しばらく経ってからもう一度お試しください。',
  TIMEOUT: '通信がタイムアウトしました。しばらく経ってからもう一度お試しください。',
  UNEXPEXTED_ERROR: '予期せぬエラーが発生しました。',
};
