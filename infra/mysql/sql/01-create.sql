...
-- -----------------------------------------------------
-- Table `books`.`inquiries`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `books`.`inquiries` (
  ...
  `is_replied` TINYINT UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  INDEX `fk_inquiries_users_01` (`users_id` ASC) VISIBLE,
  INDEX `fk_inquiries_users1_idx` (`person_in_charge` ASC) VISIBLE,
  CONSTRAINT `fk_inquiries_users2`
...
CREATE TABLE IF NOT EXISTS `informations`.`notifications` (
  ...
  `categories_id` BIGINT(20) UNSIGNED NULL,
  `title` VARCHAR(64) NOT NULL DEFAULT '',
  `description` TEXT(2000) NOT NULL DEFAULT '',
  ...
  INDEX `fk_notifications_categories_01_idx` (`categories_id` ASC) VISIBLE,
