...
CREATE TABLE IF NOT EXISTS `books`.`books` (
  ...
  `description` TEXT(2000) NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `books`.`reviews` (
  ...
  `impression` TEXT(2000) NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `informations`.`inquiries` (
  ...
  `updated_at` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_inquiries_users_01_idx` (`sender_id` ASC) VISIBLE,
  INDEX `fk_inquiries_users_02_idx` (`admin_id` ASC) VISIBLE,
  CONSTRAINT `fk_inquiries_users_01`
    FOREIGN KEY (`sender_id`)
    REFERENCES `users`.`users` (`id`)
    ON DELETE SET NULL
    ON UPDATE CASCADE,
  CONSTRAINT `fk_inquiries_users_02`
