...
func (m *MockUserApplication) Authorization(ctx context.Context) (int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Authorization", ctx)
	ret0, _ := ret[0].(int)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUserApplicationMockRecorder) Authorization(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Authorization", reflect.TypeOf((*MockUserApplication)(nil).Authorization), ctx)
}
...
func (m *MockUserApplication) HasAdminRole(role int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "HasAdminRole", role)
	ret0, _ := ret[0].(error)
	return ret0
}

// HasAdminRole indicates an expected call of HasAdminRole.
func (mr *MockUserApplicationMockRecorder) HasAdminRole(role interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "HasAdminRole", reflect.TypeOf((*MockUserApplication)(nil).HasAdminRole), role)
}
