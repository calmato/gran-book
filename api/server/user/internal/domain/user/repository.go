...
type Repository interface {
	...
	List(ctx context.Context, q *database.ListQuery) ([]*User, error)
	ListFollow(ctx context.Context, q *database.ListQuery) ([]*Follow, error)
	ListFollower(ctx context.Context, q *database.ListQuery) ([]*Follower, error)
