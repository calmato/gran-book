...
import { getBook, getBookByIsbn, listBookReview, multiGetUser } from '~/api'
import { IGetBookByIsbnInput, IGetBookInput, IListBookReviewInput, IMultiGetUserInput } from '~/types/input'
import {
  IBookOutput,
  IBookOutputAuthor,
  IReviewListOutput,
