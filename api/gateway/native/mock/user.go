...
func (m *MockUserServiceClient) MultiGetUser(ctx context.Context, in *proto.MultiGetUserRequest, opts ...grpc.CallOption) (*proto.UserMapResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*proto.UserMapResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// MultiGetUser mocks base method.
func (m *MockUserServiceServer) MultiGetUser(arg0 context.Context, arg1 *proto.MultiGetUserRequest) (*proto.UserMapResponse, error) {
	m.ctrl.T.Helper()
