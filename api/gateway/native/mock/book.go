...
func (m *MockBookServiceClient) MultiGetBooks(ctx context.Context, in *proto.MultiGetBooksRequest, opts ...grpc.CallOption) (*proto.BookListResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*proto.BookListResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// MultiGetBooks mocks base method.
func (m *MockBookServiceServer) MultiGetBooks(arg0 context.Context, arg1 *proto.MultiGetBooksRequest) (*proto.BookListResponse, error) {
	m.ctrl.T.Helper()
