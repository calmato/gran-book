...
// Source: proto/chat_service_grpc.pb.go
...
func (m *MockChatServiceClient) CreateMessage(ctx context.Context, in *proto.CreateChatMessageRequest, opts ...grpc.CallOption) (*proto.ChatMessageResponse, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*proto.ChatMessageResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockChatServiceClient) CreateRoom(ctx context.Context, in *proto.CreateChatRoomRequest, opts ...grpc.CallOption) (*proto.ChatRoomResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*proto.ChatRoomResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockChatServiceClient) ListRoom(ctx context.Context, in *proto.ListChatRoomRequest, opts ...grpc.CallOption) (*proto.ChatRoomListResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*proto.ChatRoomListResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockChatServiceClient) UploadImage(ctx context.Context, opts ...grpc.CallOption) (proto.ChatService_UploadImageClient, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(proto.ChatService_UploadImageClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockChatService_UploadImageClient) CloseAndRecv() (*proto.ChatMessageResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockChatService_UploadImageClient) Send(arg0 *proto.UploadChatImageRequest) error {
	m.ctrl.T.Helper()
...
// CreateMessage mocks base method.
func (m *MockChatServiceServer) CreateMessage(arg0 context.Context, arg1 *proto.CreateChatMessageRequest) (*proto.ChatMessageResponse, error) {
	m.ctrl.T.Helper()
...
// CreateRoom mocks base method.
func (m *MockChatServiceServer) CreateRoom(arg0 context.Context, arg1 *proto.CreateChatRoomRequest) (*proto.ChatRoomResponse, error) {
	m.ctrl.T.Helper()
...
// ListRoom mocks base method.
func (m *MockChatServiceServer) ListRoom(arg0 context.Context, arg1 *proto.ListChatRoomRequest) (*proto.ChatRoomListResponse, error) {
	m.ctrl.T.Helper()
...
// UploadImage mocks base method.
func (m *MockChatServiceServer) UploadImage(arg0 proto.ChatService_UploadImageServer) error {
	m.ctrl.T.Helper()
...
func (m *MockChatService_UploadImageServer) Recv() (*proto.UploadChatImageRequest, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Recv")
	ret0, _ := ret[0].(*proto.UploadChatImageRequest)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockChatService_UploadImageServer) SendAndClose(arg0 *proto.ChatMessageResponse) error {
	m.ctrl.T.Helper()
