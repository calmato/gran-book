...
goog.exportSymbol('proto.proto.UserProfileListResponse', null, global);
goog.exportSymbol('proto.proto.UserProfileListResponse.User', null, global);
 ...
 * @constructor
 */
proto.proto.UserProfileListResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.proto.UserProfileListResponse.repeatedFields_, null);
};
goog.inherits(proto.proto.UserProfileListResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.proto.UserProfileListResponse.displayName = 'proto.proto.UserProfileListResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.proto.UserProfileListResponse.User = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.proto.UserProfileListResponse.User, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.proto.UserProfileListResponse.User.displayName = 'proto.proto.UserProfileListResponse.User';
}
 ...
 * @const
 */
proto.proto.UserProfileListResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.proto.UserProfileListResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.proto.UserProfileListResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.proto.UserProfileListResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.UserProfileListResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    usersList: jspb.Message.toObjectList(msg.getUsersList(),
    proto.proto.UserProfileListResponse.User.toObject, includeInstance),
    limit: jspb.Message.getFieldWithDefault(msg, 2, 0),
    offset: jspb.Message.getFieldWithDefault(msg, 3, 0),
    total: jspb.Message.getFieldWithDefault(msg, 4, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.proto.UserProfileListResponse}
 */
proto.proto.UserProfileListResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.proto.UserProfileListResponse;
  return proto.proto.UserProfileListResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.proto.UserProfileListResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.proto.UserProfileListResponse}
 */
proto.proto.UserProfileListResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.proto.UserProfileListResponse.User;
      reader.readMessage(value,proto.proto.UserProfileListResponse.User.deserializeBinaryFromReader);
      msg.addUsers(value);
      break;
    case 2:
      var value = /** @type {number} */ (reader.readInt64());
 ...
 * @return {!Uint8Array}
 */
proto.proto.UserProfileListResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.proto.UserProfileListResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.proto.UserProfileListResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.UserProfileListResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUsersList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.proto.UserProfileListResponse.User.serializeBinaryToWriter
    );
  }
  f = message.getLimit();
  if (f !== 0) {
 ...
 * @return {!Object}
 */
proto.proto.UserProfileListResponse.User.prototype.toObject = function(opt_includeInstance) {
  return proto.proto.UserProfileListResponse.User.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.proto.UserProfileListResponse.User} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.UserProfileListResponse.User.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
    username: jspb.Message.getFieldWithDefault(msg, 2, ""),
    thumbnailUrl: jspb.Message.getFieldWithDefault(msg, 3, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.proto.UserProfileListResponse.User}
 */
proto.proto.UserProfileListResponse.User.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.proto.UserProfileListResponse.User;
  return proto.proto.UserProfileListResponse.User.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.proto.UserProfileListResponse.User} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.proto.UserProfileListResponse.User}
 */
proto.proto.UserProfileListResponse.User.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.proto.UserProfileListResponse.User.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.proto.UserProfileListResponse.User.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.proto.UserProfileListResponse.User} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.UserProfileListResponse.User.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.proto.UserProfileListResponse.User.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.proto.UserProfileListResponse.User.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.proto.UserProfileListResponse.User.prototype.getUsername = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.proto.UserProfileListResponse.User} returns this
 */
proto.proto.UserProfileListResponse.User.prototype.setUsername = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.proto.UserProfileListResponse.User.prototype.getThumbnailUrl = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.proto.UserProfileListResponse.User} returns this
 */
proto.proto.UserProfileListResponse.User.prototype.setThumbnailUrl = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.proto.UserProfileListResponse.User.prototype.getSelfIntroduction = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
...
/**
 * repeated User users = 1;
 * @return {!Array<!proto.proto.UserProfileListResponse.User>}
 */
proto.proto.UserProfileListResponse.prototype.getUsersList = function() {
  return /** @type{!Array<!proto.proto.UserProfileListResponse.User>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.proto.UserProfileListResponse.User, 1));
};


/**
 * @param {!Array<!proto.proto.UserProfileListResponse.User>} value
 * @return {!proto.proto.UserProfileListResponse} returns this
*/
proto.proto.UserProfileListResponse.prototype.setUsersList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.proto.UserProfileListResponse.User=} opt_value
 * @param {number=} opt_index
 * @return {!proto.proto.UserProfileListResponse.User}
 */
proto.proto.UserProfileListResponse.prototype.addUsers = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.proto.UserProfileListResponse.User, opt_index);
};
 ...
 * @return {!proto.proto.UserProfileListResponse} returns this
 */
proto.proto.UserProfileListResponse.prototype.clearUsersList = function() {
  return this.setUsersList([]);
};
 ...
 * @return {number}
 */
proto.proto.UserProfileListResponse.prototype.getLimit = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.proto.UserProfileListResponse} returns this
 */
proto.proto.UserProfileListResponse.prototype.setLimit = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.proto.UserProfileListResponse.prototype.getOffset = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.proto.UserProfileListResponse} returns this
 */
proto.proto.UserProfileListResponse.prototype.setOffset = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
 ...
 * @return {number}
 */
proto.proto.UserProfileListResponse.prototype.getTotal = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};
 ...
 * @return {!proto.proto.UserProfileListResponse} returns this
 */
proto.proto.UserProfileListResponse.prototype.setTotal = function(value) {
  return jspb.Message.setProto3IntField(this, 4, value);
};
