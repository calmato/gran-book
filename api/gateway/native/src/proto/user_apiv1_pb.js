...
goog.exportSymbol('proto.proto.SearchAdminRequest.Query', null, global);
 ...
 * @constructor
 */
proto.proto.SearchAdminRequest.Query = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.proto.SearchAdminRequest.Query, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.proto.SearchAdminRequest.Query.displayName = 'proto.proto.SearchAdminRequest.Query';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.proto.SearchAdminRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    limit: jspb.Message.getFieldWithDefault(msg, 1, 0),
    offset: jspb.Message.getFieldWithDefault(msg, 2, 0),
    query: (f = msg.getQuery()) && proto.proto.SearchAdminRequest.Query.toObject(includeInstance, f),
...
proto.proto.SearchAdminRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.proto.SearchAdminRequest.Query;
      reader.readMessage(value,proto.proto.SearchAdminRequest.Query.deserializeBinaryFromReader);
      msg.setQuery(value);
      break;
    case 4:
...
proto.proto.SearchAdminRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.proto.SearchAdminRequest.Query.serializeBinaryToWriter
    );
  }
  f = message.getOrder();
  if (f != null) {
 ...
 * @return {!Object}
 */
proto.proto.SearchAdminRequest.Query.prototype.toObject = function(opt_includeInstance) {
  return proto.proto.SearchAdminRequest.Query.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.proto.SearchAdminRequest.Query} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.SearchAdminRequest.Query.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.proto.SearchAdminRequest.Query}
 */
proto.proto.SearchAdminRequest.Query.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.proto.SearchAdminRequest.Query;
  return proto.proto.SearchAdminRequest.Query.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.proto.SearchAdminRequest.Query} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.proto.SearchAdminRequest.Query}
 */
proto.proto.SearchAdminRequest.Query.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.proto.SearchAdminRequest.Query.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.proto.SearchAdminRequest.Query.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.proto.SearchAdminRequest.Query} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.SearchAdminRequest.Query.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getField();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.proto.SearchAdminRequest.Query.prototype.getField = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.proto.SearchAdminRequest.Query} returns this
 */
proto.proto.SearchAdminRequest.Query.prototype.setField = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.proto.SearchAdminRequest.Query.prototype.getValue = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.proto.SearchAdminRequest.Query} returns this
 */
proto.proto.SearchAdminRequest.Query.prototype.setValue = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {?proto.proto.SearchAdminRequest.Query}
 */
proto.proto.SearchAdminRequest.prototype.getQuery = function() {
  return /** @type{?proto.proto.SearchAdminRequest.Query} */ (
    jspb.Message.getWrapperField(this, proto.proto.SearchAdminRequest.Query, 3));
};


/**
 * @param {?proto.proto.SearchAdminRequest.Query|undefined} value
 * @return {!proto.proto.SearchAdminRequest} returns this
*/
proto.proto.SearchAdminRequest.prototype.setQuery = function(value) {
 ...
 * @return {!proto.proto.SearchAdminRequest} returns this
 */
proto.proto.SearchAdminRequest.prototype.clearQuery = function() {
 ...
 * @return {boolean}
 */
proto.proto.SearchAdminRequest.prototype.hasQuery = function() {
...
proto.proto.SearchAdminRequest.prototype.getOrder = function() {
  return /** @type{?proto.proto.SearchAdminRequest.Order} */ (
    jspb.Message.getWrapperField(this, proto.proto.SearchAdminRequest.Order, 4));
};
