...
import (
	...
	config "github.com/calmato/gran-book/api/service/config/gateway/native"
	"github.com/calmato/gran-book/api/service/pkg/cors"
...
func Exec() error {
	...
	p := &params{
		...
		ChatServiceURL: env.ChatServiceURL,
